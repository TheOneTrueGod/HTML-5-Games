var Client = IgeClass.extend({
	...
	init: function () {
		...
		this.textures = {
			grassSheet: new IgeCellSheet('../assets/textures/tiles/grassTexture.png', 4, 1)
		};
				...
				if (success) {
					...
					ige.network.start('http://localhost:2000', function () {
						...
						self.textureMap1 = new IgeTextureMap()
							.depth(0)
							.tileWidth(ige.worldSettings.getTileWidth())
							.tileHeight(ige.worldSettings.getTileHeight())
							//.drawGrid(3)
							.drawMouse(true)
							.translateTo(0, 0, 0)
							.drawBounds(false)
						...
						ige.network.send('playerEntity', {'spawnPoint': 1});
